...
CREATE TABLE `ticket_departments` (
  ...
  `status` enum('Y','N') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'Y',
...
INSERT INTO `ticket_departments` VALUES (1,'IT',0,0,'Y',NULL,NULL),(2,'SALES',0,0,'Y',NULL,NULL);
