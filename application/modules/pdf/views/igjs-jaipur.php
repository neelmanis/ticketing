...
<style type="text/css">
  ...
  .bg_dots1 { width: 103px; height: 89px; position: absolute; top: 0px; left: 0px; background:url(./assets/web/images/badges/dots_top.jpg); z-index: -1;}
  .bg_dots2 {width: 103px; height: 89px; position: absolute; background:url(./assets/web/images/badges/bg_bottom.jpg);bottom: 50%; right: 0px;}
...
<body>
  <div>
   ...
   <table cellpadding="20" style=" margin-left: -34px;margin-top: -46px;margin-right: -56px;margin-bottom: -80px; font-size:12px; font-family:Arial, Helvetica, sans-serif; width:100%;">
       ...
       <tr>
         <td style="width: 50%;border:1px solid #000;">
           <table style="width: 100%;">
             <tbody>
              <!-- <tr>
                 <td colspan="2" style="text-align: center;"><p style="font-weight: 600;color: #717171;">Organised by</p></td>
                 
               </tr> -->
               <tr>
                 <td colspan="2" style="text-align: center;/* margin-bottom: 33px; */"><img src="<?php echo base_url();?>assets/web/images/badges/Untitled-11.jpg" style="width: 150px;margin-bottom: 15px;"></td>
