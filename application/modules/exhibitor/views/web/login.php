...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo $global['web_assets']; ?>images/favicon.ico">
  ...
  <body class="skin-blue card-no-border">
    ...
    <section id="wrapper">
      ...
      <div class="login-register  darkBlueBg">
        <div class="card login-box">
          <div class="card-body ">
            <form id="exhibitor_login" class="form-material"  autocomplete="false">
            <div class="form-group mb-2 ">
            <div class="col-md-12 text-center">
            <img src="<?php echo  base_url("assets/admin/images/gjepc_logo.png");?>" class="img-fluid w-25"> 
            <h3 class="box-title text-center mt-2 text-bold"><span style="font-weight: 700;">EXHIBITOR LOGIN </span></h3>
            </div>
            </div>
    ...
    <script src="<?php echo base_url(); ?>assets/utils/js/admin/exhibitor.js?<?php echo $global['version']; ?>"></script>
    <script>
