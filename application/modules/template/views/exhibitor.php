...
<html lang="en">
  ...
  <body class="skin-green fixed-layout">
    ...
    <div id="preloader" class="vh-100">
      <div class="d-flex justify-content-center h-100">
        <div id="status" class="m-auto">
          <div class="ring">Scanning app<span></span> </div>    
        </div>
      </div>
    </div>

    <div id="main-wrapper">
      <?php $this->load->view('includes/exhibitor/header.php'); ?>
      <?php $this->load->view('includes/exhibitor/side-menu.php'); ?>
    ...
    <?php if(isset($scriptFile) && ! empty($scriptFile)){ ?>
      <script src="<?php echo base_url(); ?>assets/utils/js/exhibitor/<?php echo $scriptFile.'.js?'.$global['version']; ?>"></script>
    <?php } ?>
