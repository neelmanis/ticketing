  ...
  <div style="margin:0 auto; max-width:700px; width:700px; position:relative; line-height:18px;">
    ...
    <tr>
      <td style="padding:30px 30px 30px 30px;">
        ...
        <br />
        <p style="">Welome to Adraas! </p>
        <br />
        <p style=" font-size: 14px;">You have successfully registered on Adraas- Realtime Environment for Dispute Resolution. To continue using the platform, please login using this link: <a href="https://adraas.com/">https://adraas.com/</a> </p>
        <br />
