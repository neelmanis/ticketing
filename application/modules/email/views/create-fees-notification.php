  ...
  <div style="margin:0 auto; max-width:700px; width:700px; position:relative; line-height:18px;">
    ...
    <tr>
      <td style="padding:30px 30px 30px 30px;">
        ...
        <br />
        <p style="color:#02015e; font-size: 14px;">Institution  <?php echo $institution_name; ?> has created  <?php echo $fees_component; ?>  for the case <?php echo $case_id; ?></p>
        <p style="color:#02015e; font-size: 14px;">Payable amount is <?php echo $calculated_fees; ?></p>
        <p style="color:#02015e; font-size: 14px;">Log in at <a href="https://adraas.com/" target="_blank">https://adraas.com/</a> and pay fees.</p>
        <br>
        <p>Regards,</p>
