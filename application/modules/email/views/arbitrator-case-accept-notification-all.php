  ...
  <div style="margin:0 auto; max-width:700px; width:700px; position:relative; line-height:18px;">
    ...
    <tr>
      <td style="padding:30px 30px 30px 30px;">
        ...
        <p style="color:#02015e; font-size: 14px;"> Arbitrator <?php echo $arbitrator_name; ?> has <?php echo $status; ?> arbitration request for  <strong><?php echo $case_serial_no; ?></strong> </p>
