  ...
  <div style="margin:0 auto; max-width:700px; width:700px; position:relative; line-height:18px;">
    ...
    <tr>
      <td style="padding:30px 30px 30px 30px;">
        ...
        <p style="color:#02015e; font-size: 14px;">We have received request to register this email id. Kindly click the link below : </p>
        <p><strong style="font-weight:bold;">  <a href="<?php echo $account_link; ?>">Click here to verify</a></strong>.</p>
