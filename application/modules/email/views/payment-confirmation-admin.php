  ...
  <div style="margin:0 auto; max-width:700px; width:700px; position:relative; line-height:18px;">
    ...
    <tr>
      <td style="padding:30px 30px 30px 30px;">
        <p style=""><strong>Hello Admin</strong></p>
        <br />
        <p style=""> <?php echo ucfirst($name) ;?> has paid <?php echo $amount; ?></p>
        <p style="">Order id : <?php echo $order_id; ?></p>
        <p style="">Payment mode : <?php echo $mode; ?></p>
        <p style="">Case ID : <?php echo $case_id; ?></p>
        <p style="">Log in at <a href="https://adraas.com/" target="_blank">https://adraas.com/admin</a> and upload invoice.</p>
        <br>
        <p>Regards,</p>
