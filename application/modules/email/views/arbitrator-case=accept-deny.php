  ...
  <div style="margin:0 auto; max-width:700px; width:700px; position:relative; line-height:18px;">
    ...
    <tr>
      <td style="padding:30px 30px 30px 30px;">
        ...
        <p style="color:#02015e; font-size: 14px;">Institution <?php echo $institution_name; ?> has nominated you for appointment as an arbitrator for Arbitration Case ID <strong><?php echo $case_serial; ?></strong> </p>

        <p> Please find case details <button style="font-weight:bold; margin-right:20px"><a href="<?php echo $info_link; ?>">here</a></button>. To accept or reject the nomination click on below link, </p>
        <p><button style="font-weight:bold; margin-right:20px"><a href="<?php echo $accept_link; ?>">Accept</a></button> <button style="font-weight:bold;"><a href="<?php echo $deny_link; ?>">Deny</a></button></p>
