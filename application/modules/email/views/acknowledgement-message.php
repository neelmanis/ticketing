  ...
  <div style="margin:0 auto; max-width:700px; width:700px; position:relative; line-height:18px;">
    ...
    <tr>
      <td style="padding:30px 30px 30px 30px;">
        ...
        <p style="color:#02015e; font-size: 14px;">Case Id : <?php echo $case_id; ?></p>
        <p style="color:#02015e; font-size: 14px;">Event : <?php echo $event; ?></p>
        <p style="color:#02015e; font-size: 14px;">Event has been acknowledged by <?php echo $acknowledged_by; ?></p>
