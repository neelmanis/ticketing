  ...
  <div style="margin:0 auto; max-width:700px; width:700px; position:relative; line-height:18px;">
    ...
    <tr>
      <td style="padding:30px 30px 30px 30px;">
        ...
        <p style=" font-size: 14px;">It seems you have forgotten your password.: </p>
        <p style=" font-size: 14px;"> You may set new password for your account using the link below: </p>

        <p><strong style="font-weight:bold;">  <a href="<?php echo $account_link; ?>">Click here</a> </strong></p>
